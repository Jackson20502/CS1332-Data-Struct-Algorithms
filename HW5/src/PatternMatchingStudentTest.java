...
public class PatternMatchingStudentTest {
    ...
    public void testBuildFailureTableEmpty() {
        String emptyPattern = "";
        int[] failureTable = PatternMatching.buildFailureTable(emptyPattern, comparator);
        assertArrayEquals(failureTable, new int[0]);
    }

    @Test(timeout = TIMEOUT)
    public void testBuildFailureTableSingleElement() {
        String oneElement = "a";
        int[] failureTable = PatternMatching.buildFailureTable(oneElement, comparator);
        assertArrayEquals(failureTable, new int[1]);
    }

    @Test(timeout = TIMEOUT)
    public void testBuildFailureTableComplex() {
        String testPattern = "ababcabababcb";
        int[] failureTable = PatternMatching.buildFailureTable(testPattern, comparator);
    ...
    public void testKMPEmpty() {
        String emptyText = "";
        List<Integer> occurrenceList = PatternMatching.kmp("a", emptyText, comparator);
        assertEquals(0, comparator.getComparisonCount());
        assertEquals(new ArrayList<Integer>(), occurrenceList);
    }

    @Test(timeout = TIMEOUT)
    public void testKMPComplex() {
        String pattern = "abcaba";
        String text = "abcabcbbabcacabcaba";
    ...
    @Test(timeout = TIMEOUT)
    public void testBuildLOTableEmpty() {
        String emptyPattern = "";
        Map<Character, Integer> lastTable = PatternMatching.buildLastTable(emptyPattern);
        assertEquals(new HashMap<Character, Integer>(), lastTable);
    }

    @Test(timeout = TIMEOUT)
    public void testBuildLOTableSingleElement() {
        String oneElement = "a";
        Map<Character, Integer> lastTable = PatternMatching.buildLastTable(oneElement);
        Map<Character, Integer> loTableExpected = new HashMap<>();
        loTableExpected.put('a', 0);
        assertEquals(loTableExpected, lastTable);
    }

    @Test(timeout = TIMEOUT)
    public void testBuildLOTableComplex() {
        String testPattern = "ababcabababcb";
        Map<Character, Integer> lastTable = PatternMatching.buildLastTable(testPattern);
        Map<Character, Integer> loTableExpected = new HashMap<>();
        loTableExpected.put('a', 9);
        loTableExpected.put('c', 11);
        loTableExpected.put('b', 12);
        assertEquals(loTableExpected, lastTable);
    }
    ...
    public void testBoyerMooreEmpty() {
        String emptyText = "";
        List<Integer> occurrenceList = PatternMatching.boyerMoore("a", emptyText, comparator);
        assertEquals(0, comparator.getComparisonCount());
        assertEquals(new ArrayList<Integer>(), occurrenceList);
    }

    @Test(timeout = TIMEOUT)
    public void testBoyerMooreComplex() {
        String pattern = "abcaba";
        String text = "abcabcbbabcacabcaba";
        List<Integer> expected = new ArrayList<>();
        expected.add(13);
    ...
    public void testRabinKarpEmpty() {
        String emptyText = "";
        List<Integer> occurrenceList = PatternMatching.rabinKarp("a", emptyText, comparator);
        assertEquals(0, comparator.getComparisonCount());
        assertEquals(new ArrayList<Integer>(), occurrenceList);
    }

    @Test(timeout = TIMEOUT)
    public void testRabinKarpComplex() {
        String text = "abcbabbacabc";
        List<Integer> occurrenceList = PatternMatching.rabinKarp("abc", text, comparator);
        List<Integer> expected = new ArrayList<>();
        expected.add(0);
        expected.add(9);
        assertEquals(expected, occurrenceList);
        assertEquals("Comparison count was " + comparator.getComparisonCount()
